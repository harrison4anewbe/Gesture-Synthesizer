...
# import data
cur_path = "./gdrive/MyDrive/Colab Notebooks/nlp-text-emotion-master"
data_train = pd.read_csv(cur_path + "/data/train_out.csv", encoding="utf-8")
data_test = pd.read_csv(cur_path + "/data/test_out.csv", encoding="utf-8")
